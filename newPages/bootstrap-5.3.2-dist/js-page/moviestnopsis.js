        ...
        <div class="row">
            ...
            <div class="col-12 d-flex flex-column  mt-3">
                ...
                <div class="d-flex justify-content-start my-2 align-items-center">
                    ...
                    <a href="#"><img src="../newPages/icon/good.png" class="img-fluid" alt="good"></a>
                </div>
            </div>
...
<div class="movieTrailer d-flex flex-column  w-100">
    ...
    <div class="d-flex justify-content-center mb-3 movieVideo">
            <div id="player"></div>
        </div>
    <div class="movieControl d-flex justify-content-center w-100">
        <div class="row g-0 justify-content-between w-75">
            ...
            <div class="col d-flex flex-column justify-content-center">
                <input type="range" class="movie-range" id="customRange1" value="0" min="0" max="100">
            </div>
        </div>
    </div>
</div>
